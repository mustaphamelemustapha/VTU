...
export default function DevDocs() {
  const [activeTab, setActiveTab] = useState('data'); // 'balance' | 'data' | 'airtime' | 'plans'
        ...
        <aside className="hidden lg:block space-y-6 h-fit sticky top-24">
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1 text-sm text-slate-300">
              ...
              <li><a href="#plans" className="block py-1 hover:text-orange-500 transition-colors font-mono">/data/plans</a></li>
          ...
          <section className="grid gap-10 xl:grid-cols-[1fr_1.1fr]">
            ...
            <div className="space-y-12">
              ...
              <div id="plans" className="space-y-3 pt-6 border-t border-slate-900 scroll-mt-20">
                ...
                <p className="text-slate-400 text-sm">Retrieve a list of all active data plans, including their plan IDs, codes, and your custom agent pricing.</p>
              </div>
